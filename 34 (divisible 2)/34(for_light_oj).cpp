...
void solve() {
    ...
    // Note : This submission is not accepted by dimikoj
    // I think there is a problem in the oj because when i submit same
    // solution in lightoj in the same dimikoj problem it is accpeted

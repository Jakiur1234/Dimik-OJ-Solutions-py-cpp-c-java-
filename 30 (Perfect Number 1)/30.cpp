...
void solve() {
    string str;
    SS(str);
    if(str == "6" || str == "28" || str == "496" || str == "8128" || str == "33550336" || str == "8589869056" || str == "137438691328" || str == "2305843008139952128"){
        pf("YES, ");
        pfsn(str," is a perfect number!");
    }
    else{
        pf("NO, ");
        pfsn(str," is not a perfect number!");
    }
}
